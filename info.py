...
API_ID = int(environ.get('API_ID', '25750006'))
API_HASH = environ.get('API_HASH', '9707616e3703ade0dec6d951780f9cca')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7259440235').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002444363967').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://krjnstore:pzCjaDgqaj51069M@cluster0.t0upy7y.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002591125289))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002554115569')).split()]
